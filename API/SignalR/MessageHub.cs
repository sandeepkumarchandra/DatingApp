...
namespace API.SignalR
{
    public class MessageHub : Hub
    {
        ...
        public MessageHub(IMapper mapper, UnitOfWork unitOfWork , 
        ...
        public async Task SendMessage(CreateMessageDto createMessageDto)
        {
            ...
            if(username == createMessageDto.RecipientUsername) throw new HubException("You can't send message to yourself");

            var sender = await _userRepository.GetUserByUsernameAsync(username);
            var recipient = await _userRepository.GetUserByUsernameAsync(createMessageDto.RecipientUsername.ToLower());

            if(recipient == null) throw new HubException("User doesn't exsist");
